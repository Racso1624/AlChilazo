...
MongoDbModel_User mongoDbModel_UserToFromJson(
        String str) => // coverage:ignore-line
    MongoDbModel_User.fromJson(json.decode(str)); // coverage:ignore-line
// coverage:ignore-line
String mongoDbModel_UserToJson(
        MongoDbModel_User data) => // coverage:ignore-line
...
class MongoDbModel_User {
  ...
  factory MongoDbModel_User.fromJson(
